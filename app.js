...
var taskInput=document.getElementById("add-item__input-id");//Add a new task.
var addButton=document.getElementsByTagName("button")[0];//first button
var incompleteTaskHolder=document.querySelector(".todo");//ul of #todo
var completedTasksHolder=document.querySelector(".completed");//completed
...
var createNewTaskElement=function(taskString){
    ...
    label.className="add-item__task";

    //Each elements, needs appending
    checkBox.type="checkbox";
    editInput.type="text";
    editInput.className="add-item__task";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("todo-list-edit");
    //If class of the parent is .todo-list-edit
    if(containsClass){

        //switch to .todo-list-edit
    ...
    //toggle .todo-list-edit on the parent.
